...
package me.zirko.epidroid.ui.widget;
...
/**
 * A {@link NetworkImageView} that draws its contents inside a mask and draws a border
 * drawable on top. This is useful for applying a beveled look to image contents, but is also
 * flexible enough for use with other desired aesthetics.
 */
public class NetworkBezelImageView extends NetworkImageView {
    ...
    public NetworkBezelImageView(Context context) {
        this(context, null);
    }

    public NetworkBezelImageView(Context context, AttributeSet attrs) {
    ...
    public NetworkBezelImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.NetworkBezelImageView,
                defStyle, 0);
        ...
        mDesaturateOnPress = a.getBoolean(R.styleable.NetworkBezelImageView_desaturateOnPress,
                mDesaturateOnPress);
